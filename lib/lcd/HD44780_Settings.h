...
//LCD pins			PORT, PIN
#define LCD_RS		D, 1 // Arduino 1
#define LCD_RW		D, 2 // Arduino 2
#define LCD_EN		D, 3 // Arduino 3

#define LCD_D4		D, 4 // Arduino 4
#define LCD_D5		D, 5 // Arduino 5
#define LCD_D6		D, 6 // Arduino 6
#define LCD_D7		D, 7 // Arduino 7
//----------------------------------------------//
#endif
